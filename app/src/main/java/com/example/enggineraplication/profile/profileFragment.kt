...
class profileFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.updateprofile.setOnClickListener {
            startActivityForResult(
                ...
                updateProfileActivity.ADD_WORD_REQUEST_CODE
            )
        }
        binding.addskill.setOnClickListener {
            startActivityForResult(
                Intent(context, addSkillActivity::class.java),
                addSkillActivity.ADD_WORD_REQUEST_CODE
            )
        }
        return binding.root
    ...
    private fun useCoroutineToCallAPI() {
        ...
        val service =
            context?.let { ApiClient.getApiClient(it)?.create(detailworkerapiservice::class.java) }
    ...
    private fun skillAPI() {
        ...
        val service =
            context?.let { ApiClient.getApiClient(it)?.create(skillApiService::class.java) }
